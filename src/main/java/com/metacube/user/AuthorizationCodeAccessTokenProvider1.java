 ...
 * @author Dave Syer
 */
public class AuthorizationCodeAccessTokenProvider1 extends OAuth2AccessTokenSupport implements AccessTokenProvider {
    ...
    private UserRedirectRequiredException getRedirectForAuthorization(AuthorizationCodeResourceDetails resource,
        ...
        String email = "test@metacube.com";
        if (request.get("email") != null && request.get("email").get(0) != null) {
          email =  request.get("email").get(0);
        }
